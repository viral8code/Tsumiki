namespace Tsumiki.Core.Evidence
{
    ...
    internal sealed class 証拠較正器
    {
        ...
        /// <summary>
        /// 支持本数を 0〜1 の確信度へ潰すときの時定数。この本数あたりで
        /// 6割強に達し、以降は増やしてもほとんど動かなくなる。
        /// </summary>
        ...
        ///
        /// 本数をそのまま足し合わせると、ほぼ同じ条件のペアが1000本あるだけで
        /// 種類の違う証拠1本を完全に押し流してしまう。頭打ちにすることで、
        ...
        /// 読み直しである可能性が高く、別々の分子から得た裏付けとは言えない。
