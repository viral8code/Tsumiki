...
namespace Tsumiki.Commons
{
    ...
    internal static class ConfigurationManager
    {
        ...
        /// <summary>
        /// 直近の KmerCutoffSelector.V_解決_kmerカットオフ で k-mer スペクトルに適合した混合モデル
        /// </summary>
        /// <remarks>
        /// CopyNumberEstimator の単一コピー基準値や GraphSimplifier の tip 判定の「無条件に信頼する下限」が、カットオフと同じモデルから導いた値を共有するために公開する<br/>
