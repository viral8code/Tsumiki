...
namespace Tsumiki.Core
{
    ...
    internal partial class ContigMaker
    {
        ...
        public void V_マッピング_リード(string p_リードパス)
        {
            ...
            void l_処理(string l_リード, int l_ワーカー番号)
            {
                this.V_マッピング_1リード(l_リード, l_ローカル隣接[l_ワーカー番号]);
            }
        ...
        public void V_マッピング_ペアリード(string p_リード1のパス, string p_リード2のパス)
        {
            ...
            void l_処理((string A_リード1, string A_リード2) l_ペア, int l_ワーカー番号)
            {
                this.V_処理_1ペア(l_ペア.A_リード1, l_ペア.A_リード2, l_ローカル隣接[l_ワーカー番号], l_ローカルペア経路[l_ワーカー番号], l_ローカル同一向き標本[l_ワーカー番号], l_ローカル逆向き標本[l_ワーカー番号]);
            }
