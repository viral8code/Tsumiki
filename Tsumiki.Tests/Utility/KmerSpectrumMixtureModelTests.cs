...
namespace Tsumiki.Tests.Utility
{
    ...
    public class KmerSpectrumMixtureModelTests
    {
        ...
        /// </summary>
        [Fact]
        public void V_理論混合分布から単一コピー平均を復元できる()
        {
        ...
        /// <summary>
        /// 低カバレッジ気味 (単一コピー平均が誤り成分の平均に近い) でも、谷が視認できるかどうかに関わらずモデルが分離できることを確かめる
        /// </summary>
        [Fact]
        public void V_低カバレッジでも成分を分離できる()
        {
        ...
        {
            var l_p = 1.0D / p_平均;
            return Math.Pow(1D - l_p, p_出現回数 - 1D) * l_p;
        }
        ...
        /// <returns></returns>
        private static Dictionary<ulong, long> Get_理論ヒストグラム(double p_λ, double p_誤り混合比, double p_誤り平均, double[] p_コピー数別混合比, int p_上限, long p_総数)
        {
