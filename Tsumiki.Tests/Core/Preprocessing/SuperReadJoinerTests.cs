...
namespace Tsumiki.Tests.Core
{
    ...
    public class SuperReadJoinerTests : IDisposable
    {
        ...
        {
            const int l_k長 = 21;
            var l_接頭配列 = V_生成_ランダム配列(80, p_シード: 11);
        ...
        /// <summary>
        /// read1 と RC (read2) がそのまま隣接する (橋渡しの長さが 0 の) ケースも、特別扱いなく正しく 1 本に統合できること
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// 断片が read1 に収まっている (アダプタ読み抜け) 場合は、繋いでも長さが伸びないので重なりでは統合しない
        /// </summary>
        [Fact]
