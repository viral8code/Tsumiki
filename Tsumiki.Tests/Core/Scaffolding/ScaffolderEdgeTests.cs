...
namespace Tsumiki.Tests.Core
{
    ...
    public class ScaffolderEdgeTests
    {
        ...
        {
            var l_候補 = new List<Scaffold候補> { V_構築_scaffold候補(4, 20UL, 0.5D), V_構築_scaffold候補(6, 18UL, 0.45D) };
        ...
        private static Scaffold候補 V_構築_scaffold候補(int p_行き先, ulong p_支持数, double p_期待比)
        {
