...
namespace Tsumiki.Common
{
    internal static class ConfigurationManager
    {
        ...
        /// 適合した混合モデル。CopyNumberEstimator の単一コピー基準値や
        /// GraphSimplifier の tip 判定の「無条件に信頼する下限」が、カットオフと
        /// 同じモデルから導いた値を共有するために公開する。適合に失敗した場合や
        /// -kc が明示指定された場合は null のままで、各所は自前の推定にフォールバックする。
        /// </summary>
