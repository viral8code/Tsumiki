namespace Tsumiki.Models.ContigBuilding
{
    ...
    /// </summary>
    /// <remarks>
    /// Scaffolder はこれを使って「unitig 単位のペアエンド隣接候補」を「contig 単位のスキャフォールディング候補」へ変換する<br/>
    ...
    /// <param name="p_Isコンティグ逆相補"></param>
    /// <param name="p_walk順の位置"></param>
    /// <param name="p_walk順の総数"></param>
    /// <param name="p_Iswalk中逆鎖"></param>
    internal readonly struct ユニティグ配置(int p_コンティグID, bool p_Isコンティグ逆相補, int p_walk順の位置, int p_walk順の総数, bool p_Iswalk中逆鎖)
    {
        #region 内部変数
        ...
        /// </summary>
        public readonly bool A_Isコンティグ逆相補 = p_Isコンティグ逆相補;
        ...
        /// </summary>
        public bool A_Isコンティグ先頭 => this.A_walk順の位置 == 0;

        /// <summary>
        /// この unitig が contig の末尾 (3' 端) に位置するか
        /// </summary>
        public bool A_Isコンティグ末尾 => this.A_walk順の位置 == this.A_walk順の総数 - 1;
