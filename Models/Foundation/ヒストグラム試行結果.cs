namespace Tsumiki.Models.Foundation
{
    ...
    /// <param name="A_過分散"></param>
    /// <param name="A_対数尤度"></param>
    /// <param name="A_反復回数"></param>
    internal readonly record struct ヒストグラム試行結果(double A_λ, double A_誤り平均, double A_誤り混合比, double A_コピー数減衰率, double A_過分散, double A_対数尤度, int A_反復回数);
}
