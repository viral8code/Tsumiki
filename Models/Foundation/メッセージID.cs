namespace Tsumiki.Models.Foundation
{
    ...
    internal enum メッセージID
    {
        ...
        /// <summary>
        /// 前段 k の経路引き継ぎを何本マッピングしたか
        /// </summary>
        経路引き継ぎのマッピング数,

        /// <summary>
        /// 前段 k の経路引き継ぎで解決した分岐の数
        /// </summary>
        経路引き継ぎで解決した数,
        ...
        /// <summary>
        /// 手前の単一コピー unitig から通り抜けたリードで決めた分岐の数
        /// </summary>
        経路で解決した分岐数,
        ...
        /// <summary>コピー数基準オプションのヘルプ文</summary>
        ヘルプ_コピー数基準,

        /// <summary>低カバレッジ端トリミング無効化オプションのヘルプ文</summary>
        ヘルプ_低カバレッジ端トリミングなし,
